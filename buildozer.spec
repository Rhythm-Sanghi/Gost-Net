...
requirements = python3,kivy==2.3.0,kivymd==1.1.1,cryptography,pillow
...
# 2) android.add_assets = source_dir/asset_dir:destination_dir
#android.add_assets =

# (list) Put these files or directories in the apk res directory.
# 1) android.add_res = source_dir/res_dir
# 2) android.add_res = source_dir/res_dir:res_subdir
#android.add_res =
...
# (list) python-for-android whitelist of recipes to compile
#p4a.whitelist =

# (bool) If True, bootstrap will be copied into distribution instead of using hardlink
# p4a.bootstrap = sdl2

# (str) The directory in which python-for-android should look for your own distribution recipes (if any)
#p4a.local_distributions =
